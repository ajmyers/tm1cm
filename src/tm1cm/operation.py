...
class Operation:
    ...
    def __str__(self):
        return f'{self._operation.upper()}_{self._scope.type.upper()}: {self._name}'
    ...
    #         if session.cubes.exists(cube_name):
    #             cube = session.cubes.get(cube_name)
    #             cube.rules = Rules(self.scope.rules[cube_name]['Rules'])
    #             session.cubes.update(cube)
    #         else:
    ...
    #
    #     try:
    #         cube = self.scope.cubes[cube_name]
    ...
    #     try:
    #         view = json.dumps(self.scope.get_view(cube_name, view_name), ensure_ascii=False)
    #
    #         if session.cubes.views.exists(cube_name, view_name, False):
    ...
    #             locked = False
    #
    #         view_data = self.scope.get_view_data(cube_name, view_name)
    ...
    #     rest = session._tm1_rest
    #     try:
    #         subset = json.dumps(self.scope.get_subset(dimension_name, hierarchy_name, subset_name), ensure_ascii=False)
    #         if session.dimensions.subsets.exists(subset_name, dimension_name, hierarchy_name, False):
    ...
    #
    #     try:
    #         data = self.scope.get_hierarchy(dimension_name, hierarchy_name)
    ...
    #     session = self.target.session
    #     try:
    #         data = self.scope.dimensions[dimension_name]
    ...
    #     session = self.target.session
    #     try:
    #         process = self.scope.processes[process_name]
    ...
    #         data = self.scope.get_file(file_name)
    #
    #         try:
